...
title PCB Selenium Test - Visible Edge

set "BACKEND_DIR=%~dp0backend"
set "SCRIPT=%~dp0Selenium_tests\visible_test.py"
set "HOST=0.0.0.0"
set "PORT=8000"
...
echo.
echo  ============================================
echo     PCB Selenium Test - Visible Edge
echo  ============================================
echo.
...
"%PYTHON_EXE%" -m pip install selenium -q 2>nul
...
echo  [5/5] Running visible Edge browser tests...
echo.
"%PYTHON_EXE%" "%SCRIPT%"
