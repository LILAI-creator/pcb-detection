...
echo  [2/5] Checking Node and dependencies...
where node >nul 2>&1
if !errorlevel! neq 0 (
...
if not exist "node_modules\newman-reporter-htmlextra" (
    echo  [INFO] Installing newman-reporter-htmlextra...
    call npm install newman-reporter-htmlextra >nul 2>&1
)
